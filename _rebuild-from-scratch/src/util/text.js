...
exports.escapeString = exports.indent = exports.isIdentifier = exports.isIdentifierPart = exports.isIdentifierStart = exports.isAlphaOrDecimal = exports.isHexOrDecimal = exports.isHexBase = exports.isOctal = exports.isDecimal = exports.isAlpha = exports.numCodeUnits = exports.combineSurrogates = exports.isLowSurrogate = exports.isHighSurrogate = exports.isSurrogateLow = exports.isSurrogateHigh = exports.isSurrogate = exports.SURROGATE_LOW = exports.SURROGATE_HIGH = exports.isWhiteSpace = exports.isLineBreak = void 0;
...
function isLineBreak(c) {
    switch (c) {
        ...
        case 8233 /* CharCode.ParagraphSeparator */: {
            return true;
        }
        default: {
            return false;
...
function isWhiteSpace(c) {
    ...
    switch (c) {
        ...
        case 160 /* CharCode.NonBreakingSpace */:
        case 133 /* CharCode.NextLine */:
        case 5760 /* CharCode.Ogham */:
        case 8239 /* CharCode.NarrowNoBreakSpace */:
        case 8287 /* CharCode.MathematicalSpace */:
        case 12288 /* CharCode.IdeographicSpace */:
        case 65279 /* CharCode.ByteOrderMark */: {
            return true;
        }
        default: {
            return c >= 8192 /* CharCode.EnQuad */ && c <= 8203 /* CharCode.ZeroWidthSpace */;
        }
    }
}
exports.isWhiteSpace = isWhiteSpace;
/** First high (lead) surrogate. */
exports.SURROGATE_HIGH = 0xD800;
/** First low (trail) surrogate. */
exports.SURROGATE_LOW = 0xDC00;
/** Tests if a code unit or code point is a surrogate. */
function isSurrogate(c) {
    // F800: 11111 0 0000000000 Mask
    // D800: 11011 X XXXXXXXXXX Any surrogate
    return (c & 0xF800) == exports.SURROGATE_HIGH;
}
exports.isSurrogate = isSurrogate;
/** Tests if a surrogate is a high (lead) surrogate. */
function isSurrogateHigh(c) {
    // D800-DBFF
    return c < exports.SURROGATE_LOW;
}
exports.isSurrogateHigh = isSurrogateHigh;
/** Tests if a surrogate is a low (trail) surrogate. */
function isSurrogateLow(c) {
    // DC00-DFFF
    return c >= exports.SURROGATE_LOW;
}
exports.isSurrogateLow = isSurrogateLow;
...
function isHighSurrogate(c) {
    ...
    return (c & 0xFC00) == exports.SURROGATE_HIGH;
}
...
function isLowSurrogate(c) {
    ...
    return (c & 0xFC00) == exports.SURROGATE_LOW;
}
exports.isLowSurrogate = isLowSurrogate;
/** Converts a surrogate pair to its respective code point. */
function combineSurrogates(hi, lo) {
    return 0x10000 + ((hi & 0x3FF) << 10) | (lo & 0x3FF);
}
exports.combineSurrogates = combineSurrogates;
/** Gets the number of UTF-16 code units of the specified code point. */
function numCodeUnits(cp) {
    return 1 + i32(cp > 0xffff);
}
exports.numCodeUnits = numCodeUnits;
function isAlpha(c) {
    var c0 = c | 32; // unify uppercases and lowercases a|A - z|Z
    return c0 >= 97 /* CharCode.a */ && c0 <= 122 /* CharCode.z */;
}
exports.isAlpha = isAlpha;
/** Tests if the specified character code is a valid decimal digit. */
function isDecimal(c) {
    return c >= 48 /* CharCode._0 */ && c <= 57 /* CharCode._9 */;
}
exports.isDecimal = isDecimal;
/** Tests if the specified character code is a valid octal digit. */
function isOctal(c) {
    return c >= 48 /* CharCode._0 */ && c <= 55 /* CharCode._7 */;
}
exports.isOctal = isOctal;
/** Tests if the specified character code is a valid hexadecimal symbol [a-f]. */
function isHexBase(c) {
    var c0 = c | 32; // unify uppercases and lowercases a|A - f|F
    return c0 >= 97 /* CharCode.a */ && c0 <= 102 /* CharCode.f */;
}
exports.isHexBase = isHexBase;
/** Tests if the specified character code is a valid hexadecimal digit. */
function isHexOrDecimal(c) {
    return isDecimal(c) || isHexBase(c);
}
exports.isHexOrDecimal = isHexOrDecimal;
/** Tests if the specified character code is trivially alphanumeric. */
function isAlphaOrDecimal(c) {
    return isAlpha(c) || isDecimal(c);
}
exports.isAlphaOrDecimal = isAlphaOrDecimal;
/** Tests if the specified code point is a valid start of an identifier. */
function isIdentifierStart(cp) {
    return isAlpha(cp)
        || cp == 95 /* CharCode._ */
        || cp == 36 /* CharCode.Dollar */
...
var unicodeIdentifierStartMin = 170;
var unicodeIdentifierStartMax = 201546;
...
var unicodeIdentifierPartMin = 170;
var unicodeIdentifierPartMax = 917999;
    ...
    for (var k = str.length; i < k;) {
        switch (str.charCodeAt(i)) {
            ...
            case 34 /* CharCode.DoubleQuote */: {
                if (quote == 34 /* CharCode.DoubleQuote */) {
                    if (i > off)
                        sb.push(str.substring(off, i));
                    sb.push("\\\"");
                    off = ++i;
            ...
            case 39 /* CharCode.SingleQuote */: {
                if (quote == 39 /* CharCode.SingleQuote */) {
                    if (i > off)
                        sb.push(str.substring(off, i));
                    sb.push("\\'");
                    off = ++i;
